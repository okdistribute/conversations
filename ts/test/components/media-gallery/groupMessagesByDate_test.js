...
const groupMessagesByDate_1 = require("../../../components/conversation/media-gallery/groupMessagesByDate");
const toMessage = (date) => ({
    id: date.toUTCString(),
...
describe('groupMessagesByDate', () => {
    it('should group messages', () => {
        ...
        const actual = groupMessagesByDate_1.groupMessagesByDate(referenceTime, input);
